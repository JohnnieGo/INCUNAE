...
function App() {
  ...
  function changeThemeData() {
    ...
    if (currentColorIndex === colors.length - 1) {
      ...
      setThemeData({
        ...
        nextColor: colors[currentColorIndex + 2],
      });
    }
  ...
  function setInputDataWithAProp(key, val) {
    setInputData((prevInputData) => {
      return { ...prevInputData, [key]: val };
    });
  }

  const languagesAPI =
    "https://raw.githubusercontent.com/JohnnieGo/INCUNAE/main/tess-trainedata";
  ...
  return (
    ...
    >
      <main
        ref={nodeRef}
        className={`main colorWhite ${
          isInputAreaShown ? "" : "main-grid-no-left-column"
        }`}
      ...
      >
        ...
        <div className="main-left-column no_highlights">
          <h3
            onClick={setInputAreaDisplay}
            className={`left-column-show-hide no_highlights`}
          >
            {isInputAreaShown ? "Schowaj panel" : "Pokaż panel"}
          </h3>
          {isInputAreaShown && (
            <div className="">
              <h1>Wybierz model:</h1>
              <div className="select">
                ...
                >
                  <optgroup label="Fraktura i gotyk">
                    <option value="frak2021_1.069">
                      frak2021_1.069 (0.5 MB)
                    </option>
                    <option value="frak2021-09">frak2021-09 (6 MB)</option>
                    <option value="GT4HistOCR">GT4HistOCR (4.5 MB)</option>
                    <option value="Fraktur_50000000">
                      Fraktur_50000000 (8 MB)
                    </option>
              ...
              <div
                ...
                onDragEnter={dragEnterInput}
                onDragLeave={dragExitInput}
                onMouseEnter={mouseEnterInput}
                onMouseLeave={mouseExitInput}
              >
                <InputImage
