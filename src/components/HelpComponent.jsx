...
export default function HelpComponent(props){
    ...
    return( 
            <div className='info-container' style={{backgroundColor: props.color}}>
                ...
                <p>Sytuację poprawia znajdująca się w edytorze funkcja „znajdź pochylone”, która automatycznie zmienia nierozpoznane znaki, jadnak wciąż w większości litery takie jak: ż, ź, ą, ę itd. nie są poprawnie wykrywane. sd</p>
            </div>
    )
}